...
//         <h1 className="text-2xl font-bold font-lato text-center mb-2">
//           Welcome to URL Shortener
//         </h1>

//         <p className="text-center text-gray-500 font-inter mb-6">
...
//             className="w-full bg-purple-400 text-white cursor-pointer py-2  font-semibold  rounded-lg hover:bg-purple-500 transition"

//             // px-8 py-3 bg-purple-400 text-white rounded-lg font-semibold hover:bg-purple-500 transition disabled:opacity-50
//           > 
//             Generate URL
//           </button>
//         </div>
...
//             <button
//               onClick={handleCopy}
//               className="ml-3 text-purple-400 cursor-pointer hover:text-purple-500"
//             >
